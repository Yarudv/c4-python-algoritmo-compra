...
while True: 
    ...
    if compra_producto == 1:
        cantidad_1 = int(input("Ingrese cantidad a comprar del producto 1: " ))
        stock_producto_1 = stock_producto_1 - cantidad_1
        print("El stock actual del producto 1 es: ",stock_producto_1)
        if stock_producto_1 <= 100:
            acu1 = stock_producto_1 + 50
            stock_producto_1 = acu1
    else:
        cantidad_2 = int(input("Ingrese cantidad a comprar del producto 2: " ))
        stock_producto_2 = stock_producto_2 -cantidad_2
        print("El stock actual del producto 2 es: ", stock_producto_2)
        if stock_producto_2 <= 100:
            acu2 = stock_producto_2 + 50
            stock_producto_2 = acu2
    contador = contador + 1
    if contador == 10:
        print("Stock producto 1 es:",stock_producto_1)
        print("Stock producto 2 es:",stock_producto_2)         
    elif contador == 11:
